...
func Default() *Config {
	return &Config{
		Keybinds: Keybinds{Up: "up", Down: "down", Left: "left", Right: "right", Confirm: "enter", PageUp: "pgup", PageDown: "pgdown", Top: "home", Bottom: "end", Run: "r", Build: "b", Export: "x", History: "h", Logs: "l", Stats: "s", StatsPrevious: "[", StatsNext: "]", MainScene: "m", OpenConfig: "o", ShowUpdates: "U", Quit: "q"},
